...
async function test() {
  ...
  newContentModule.title = 'Title has been updated'
  await CanvasPuppet.module.update( page, rootUrl, courseList[ courseId ], newContentModule );
